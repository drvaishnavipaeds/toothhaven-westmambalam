...
- If verification fails in Meta, the most common causes are: token typed differently than the saved secret, or the wrong app/phone number selected in the Meta dashboard. My phone number for waba is 8754256417