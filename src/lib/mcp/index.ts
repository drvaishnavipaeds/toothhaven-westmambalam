...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Tools for Tooth Haven Advanced Dental Care patients. Once signed in, you can look up your patient profile, upcoming and past appointments, prescriptions, and invoices.",
