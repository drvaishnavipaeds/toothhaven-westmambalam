...
const TEMPLATE_DEFINITIONS = [
  ...
  { name: TEMPLATES.appointmentReminder2h, category: "UTILITY" as const, language: DEFAULT_LANG, body: "Hi {{1}}, a reminder that your confirmed Tooth Haven appointment is today, {{2}}, at {{3}}. Please arrive a few minutes early.", examples: ["Karthik", "15 September 2026", "11:00 AM"] },
